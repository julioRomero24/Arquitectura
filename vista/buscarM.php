                                                ...
                                                <div class="col-12">
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-lg-8 col-md-6 col-sm-12 p-0">
                                                            <input id="iBusqueda" type="text" placeholder="Search..." class="form-control" id="search" name="search">
                                                        </div>
                                                        <div class="col-lg-1 col-md-3 col-sm-12 p-0">
                                                            <button type="button" class="btn btn-base" onclick="mostrarMonitores()">
                                                    ...
                                                    <div class="search-result">
                                                        ...
                                                        <div class="result-body">
                                                            <div class="table-responsive">
                                                                <table class="table widget-26" id="monitores">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
...
<script src="js/buscarM.js"></script>
</body>
</html>